 ...
 */
public class Style {
    private Map<StyleAttribute, Object> attributes;

    Style(final Map<StyleAttribute, Object> attributes) {
        this.attributes = attributes;
    }

    Map<StyleAttribute, Object> getAttributes() {
        return attributes;
    }
    ...
    public static StyleBuilder opacity(final Number value) {
    ...
    public static StyleBuilder textAlign(final TextAlignment.Horizontal value) {
    ...
    public static StyleBuilder textAlignVertical(final TextAlignment.Vertical value) {
