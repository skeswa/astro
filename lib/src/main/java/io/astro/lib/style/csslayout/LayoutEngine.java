 ...
 */
package io.astro.lib.style.csslayout;

import com.facebook.infer.annotation.Assertions;

import static io.astro.lib.style.csslayout.CSSLayout.DIMENSION_HEIGHT;
import static io.astro.lib.style.csslayout.CSSLayout.DIMENSION_WIDTH;
import static io.astro.lib.style.csslayout.CSSLayout.POSITION_BOTTOM;
import static io.astro.lib.style.csslayout.CSSLayout.POSITION_LEFT;
import static io.astro.lib.style.csslayout.CSSLayout.POSITION_RIGHT;
import static io.astro.lib.style.csslayout.CSSLayout.POSITION_TOP;

/**
 * Calculates layouts based on CSS style. See {@link #layoutNode(CSSLayoutContext, CSSNode, float, float, CSSDirection)}.
 */
