...
import io.astro.lib.engine.uimanager.events.TouchEvent;
import io.astro.lib.engine.uimanager.events.TouchEventCoalescingKeyHelper;
import io.astro.lib.engine.uimanager.events.TouchEventType;
...
public class JSTouchDispatcher {
   ...
   * {@link io.astro.lib.engine.uimanager.events.EventDispatcher} when appropriate.
   * It uses {@link io.astro.lib.engine.uimanager.TouchTargetHelper#findTouchTargetView}
